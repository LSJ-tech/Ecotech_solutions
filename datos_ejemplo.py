...
Escribe en la base que indique `ECOTECH_DB_PATH` en el archivo `.env`; si esa
variable no está definida, en `ecotech_solutions.db`.
...
# Nombres usados en varias tablas a la vez: como constantes, un error de escritura
# se detecta al ejecutar y no deja una asignacion apuntando a un nombre inexistente.
DESARROLLO_SOSTENIBLE = "Desarrollo Sostenible"
INVESTIGACION = "Investigacion y Desarrollo"
RECURSOS_HUMANOS = "Recursos Humanos"
VENTAS = "Ventas"

ATACAMA = "Planta fotovoltaica Atacama"
RENAICO = "Parque eolico Renaico"
MAIPO = "Monitoreo hidrico rio Maipo"
VALPARAISO = "Techos solares Valparaiso"
BIOBIO = "Reciclaje industrial Biobio"
...
def cargar() -> None:
	...
	try:
		...
		print(f"Datos de ejemplo cargados en {DATABASE_PATH}")
